...
class Fase():
    def __init__(self, intervalo_de_colisao=1):
        ...
        self._passaros = [] #atributo protegido - um alerta para o usuario n acessar pois pode gerar erros
        self._porcos = [] #atributo protegido
        self._obstaculos = [] #atributo protegido
